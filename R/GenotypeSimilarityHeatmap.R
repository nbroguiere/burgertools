...
#' @param key.title character(1), the legend/key. Default: "Fraction of matching variants"
...
GenotypeSimilarityHeatmap <- function(genotypes, key.title="Fraction of \nmatching variants", limits=NULL, plot_method="plotly", colors = viridis::viridis(n = 256, alpha = 1, begin = 0, end = 1, option = "viridis"), ...){
